        ...
        (function (contact) {
            var ribbon = /** @class */ (function () {
                ...
                ribbon.addSixMonthsInvestmentPeriod = function (context) {
                    ...
                    var date = Xrm.Page.getAttribute(OneXrm.Entities.contact.Attributes.di_maturity_date.logicalName).getValue();
                    date.setMonth(date.getMonth() + 6);
                    Xrm.Page.getAttribute(OneXrm.Entities.contact.Attributes.di_maturity_date.logicalName).setValue(date);
                };
                return ribbon;
            }());
